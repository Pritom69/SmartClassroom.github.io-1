...
<br>
        <form action="" method="POST">
            <table class="tbl-30">
                ...
                <tr>
                    <td>User Type : </td>
                    <td><input type="text" name="user_type" placeholder="Enter User_Type"value="teacher"></td>
                </tr>
                <tr>
                    <td></td>
                    <td colspan="2">
                        <input type="submit" name="submit" value="Add Teacher" class=" btn-primary">
                    </td>
                </tr>
            </table>
        </form>
...
$res = mysqli_query($conn, $sql) or die(mysqli_error());
    ...
    if($res==TRUE){
        ...
        $_SESSION['add']="<p class='btn-primary'>Teacher Added Successfully</p>";
        ...
        $_SESSION['add']="<p class='btn-danger'>Failed To Add Teacher</p>";
        //Redirect Page to Manage Admin. A dot(.) is used to concatenate string value
        header("location:".SITEURL.'panel/Admin/UserManage/TeacherManage.php');
    }
